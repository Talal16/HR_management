...
public class TimesheetMapperImpl implements TimesheetMapper {
    ...
    public TimesheetDto toDto(Timesheet timesheetEntity) {
        ...
        timesheetDto.setUser( userToUserDto( timesheetEntity.getUser() ) );
        timesheetDto.setProject( projectToProjectDto( timesheetEntity.getProject() ) );
        timesheetDto.setStartTime( timesheetEntity.getStartTime() );
        timesheetDto.setEndTime( timesheetEntity.getEndTime() );
        timesheetDto.setCreatedAt( timesheetEntity.getCreatedAt() );
        timesheetDto.setUpdatedAt( timesheetEntity.getUpdatedAt() );
